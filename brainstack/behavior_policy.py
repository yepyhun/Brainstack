    ...
    *,
    ...
    return {
        "raw_contract": {
            ...
            "receipt_id": str(raw_row.get("receipt_id") or raw_metadata.get("receipt_id") or raw_metadata.get("explicit_capture_receipt_id") or ""),
            "memory_write_receipt_id": str(raw_row.get("memory_write_receipt_id") or raw_metadata.get("memory_write_receipt_id") or ""),
            "source_lane": str(raw_row.get("source_lane") or raw_metadata.get("source_lane") or ""),
            "read_only_projection": bool(raw_row.get("read_only_projection", raw_metadata.get("read_only_projection", False))),
            "source_profile_stable_key": str(raw_metadata.get("source_profile_stable_key") or ""),
        ...
        "compiled_policy": {
            ...
            "profile_lane_projection_cache": dict(compiled_record.get("profile_lane_projection_cache") or {}),
        },
        "parity": {
