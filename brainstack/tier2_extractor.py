    ...
    messages = [
        {
            ...
            "content": (
                ...
                "- use stable slots only when a profile fact has one obvious durable owner; never emit generic identity:name\n"
                "- identity slots: identity:preferred_address_name for how the user wants to be called; identity:platform_handle for platform handle; identity:platform_display_name for display name; identity:legal_name only if explicitly stated\n"
