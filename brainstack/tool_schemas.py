...
def explicit_capture_tool_schema(*, name: str, operation: str, capture_schema_version: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "description": (
            ...
            "with category=style_preference and exact structured rule-pack content; preserve every user "
            "rule as its own newline/bullet and do not summarize, merge, or rewrite the user's rule list. "
            "Brainstack may then "
            ...
            "single-sentence summaries or partial edits remain source evidence and do not patch the active card. "
