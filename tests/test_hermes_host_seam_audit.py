...
def test_core_host_patch_inventory_skips_native_metadata_compat_seams() -> None:
    ...
    assert inventory["_patch_session_search_total_deadline"]["selected"] is True
    ...
    assert inventory["_patch_gateway_turn_profiles_capability_preserving_default"]["selected"] is True
    assert inventory["_patch_compose_remove_discord_forced_heavy_profile"]["selected"] is True
